...
class PropertyTest(unittest.TestCase):
    ...
    def test_is_group_owned_by_player(self):
        ...
        self.assertEqual(False, prop1.is_group_owned_by_player())
        self.assertEqual(False, prop2.is_group_owned_by_player())
        prop1.owner = player
        self.assertEqual(False, prop1.is_group_owned_by_player())
        prop3.owner = player
        self.assertEqual(True, prop3.is_group_owned_by_player())
        prop2.owner = None
        self.assertEqual(False, prop2.is_group_owned_by_player())
        prop1.property_group = None
        ...
        self.assertEqual(True, prop1.is_group_owned_by_player())
